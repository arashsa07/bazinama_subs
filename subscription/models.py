...
class Subscription(models.Model):
    ...
    SUB_80000 = 4
    SUBSCRIPTION_TYPES = (
        (SUB_30000, 45000),  # "شش شماره + پست سفارشی = 45000 تومان"),
        (SUB_42000, 54000),  # "شش شماره + DVD + پست سفارشی = 54000 تومان"),
        (SUB_60000, 90000),  # "دوازده شماره + پست سفارشی = 90000 تومان"),
        (SUB_80000, 108000),  # "دوازده شماره + DVD + پست سفارشی = 108000 تومان")
    )
    ...
    education = models.CharField(_('Education'), max_length=255, blank=True)
